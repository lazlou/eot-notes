...
- [eot_parquet_query.ipynb](notebooks/eot_parquet_query.ipynb): Here's an additional notebook that gives a basic overview showing how to view and query the Parquet data with DuckDB.
